 ...
 * set of looping animation webps — the exact clips shown on repdb.co. They are
 * NOT tied to specific free-tier exercises. The list is DERIVED from the files
 * present at build time: drop a `<slug>.webp` in there and it shows up in the
 * gallery, no code change.
 */
